...
//svg icon
var removeSVG = `<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 22 22" style="enable-background:new 0 0 22 22;" xml:space="preserve">               
<g><g><path class="fill" d="M16.1,3.6h-1.9V3.3c0-1.3-1-2.3-2.3-2.3h-1.7C8.9,1,7.8,2,7.8,3.3v0.2H5.9c-1.3,0-2.3,1-2.3,2.3v1.3 c0,0.5,0.4,0.9,0.9,1v10.5c0,1.3,1,2.3,2.3,2.3h8.5c1.3,0,2.3-1,2.3-2.3V8.2c0.5-0.1,0.9-0.5,0.9-1V5.9
            ...
            c0.6,0,1.1,0.5,1.1,1.1V7z"></path></g>
    <g>
        <g>
...
var completedSVG = `<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 22 22" style="enable-background:new 0 0 22 22;" xml:space="preserve">
                       
<rect y="0" class="nofill" width="22" height="22"></rect>
<g>
...
getTasks((tasks)=>{
    tasks.forEach((item) => {
        addItemToList(item,item.completed);
    });
})
// renderTodoList();
...
function addItemToDone() {
    ...
    var list = (id === 'todo') ? document.getElementById('completed') : document.getElementById('todo');
...
function addItemToList(task, complete) {
    ...
    completed.addEventListener('click', addItemToDone);
...
/** 
 * will take api results and render todo list!
*/
